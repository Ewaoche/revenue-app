            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <h3>Merchants & Collectors</h3>
                        <p>Resolve and Settle DNOs/Invoices</p>
                        <div class="page-links">
                            <a href="/ebsgigr2/pos/">POS</a>
                            <a href="/ebsgigr2/dno/">DNO</a>
                            <a class="active" href=/ebsgigr2/merchant/">Merchant</a>
                            <a href="/ebsgigr2/admin/">Admin</a>
                            <a href="/ebsgigr2/mda/">MDA</a>
                        </div>
                        <form class="allAjaxForm" action="/merchant/form/login" method="post" enctype="multipart/form-data">
